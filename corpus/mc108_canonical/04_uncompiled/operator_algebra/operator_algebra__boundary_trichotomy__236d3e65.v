...
Definition id_transformation : Transformation :=
  fun s => Some s.
...
Definition composable (g f : Transformation) : Prop :=
  forall x y : State,
    f x = Some y -> domain g y.

Parameter Delta_p : State -> R.
Parameter U_p : State -> R.
Parameter delta_p : State -> R.

Definition boundary (s : State) : R :=
  Delta_p s - U_p s - delta_p s.
...
(***
  Deferred items kept as TODO boundaries only.

  TODO: concrete boundary witnesses connecting Delta_p, U_p, delta_p
        to source-level semantics.
  TODO: trajectory type and global admissibility Adm_glob.
  TODO: certificate structure K(x,tau,pi) and completeness Comp(tau).
  TODO: composition admissibility theorem (Th 5.01), after an
        epsilon-adjustment lemma.
  TODO: event horizon partition as a derived layer over boundary_trichotomy.
  TODO: irreversibility theorem (Th 16.02).
  TODO: Gronwall-Bellman error bounds.
  TODO: lattice structure.
  TODO: falsification condition.
*)
