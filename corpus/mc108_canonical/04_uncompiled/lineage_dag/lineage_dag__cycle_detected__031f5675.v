...
Print Assumptions lineage_terminates.
Print Assumptions lineage_deterministic.
Print Assumptions cycle_detected.
Print Assumptions zero_fuel_exhausts.
Print Assumptions root_valid.
Print Assumptions eval_pred_terminates.
Print Assumptions eval_pred_deterministic.
Print Assumptions atom_always_definite.
Print Assumptions zero_fuel_none.
Print Assumptions primary_independent_of_sides.
Print Assumptions side_failure_preserves_primary.
Print Assumptions sides_mutually_independent.
Print Assumptions full_independence.
Print Assumptions empty_witnesses_valid.
Print Assumptions single_witness.
Print Assumptions invalid_witness_invalidates.
Print Assumptions witness_conjunction.
Print Assumptions witness_pair_commutative.
